...
# ]
JOINT_TARGET = [
-0.37709361711610967, -2.0401770077147425, -1.4798946380615234, -1.206785039310791, 1.5398619174957275, 1.6538000106811523]
GRID_STEP = 0.0
    # meters
GRID_NX   = 1
GRID_NY   = 1
...
TCP0 = [0.7966455468564715, -0.5067554233172332, 0.39873389903975254, -0.7112607709325791, -3.0393954463165778, 0.04809699140901531]
...
# Output file
RESULTS_XLSX = "grid_results_adv3.xlsx"
...
def main():
    ...
    for step in steps:
        distance = distance_to_steps(step)
        arduino_queue.put((f'ON {distance}', 20)) 
        time.sleep(0.2)
