...
waypoints = [
    [-0.19612859881903064, 0.5005388225571437, 0.20215797339913558, 2.9525253258559636, 1.0600413055257347, -0.0048021564553649395],
    [-0.19611135304286315, 0.560281442707811, 0.20215638744324532, 2.4019848886645003, -2.017243036165066, -0.0048021564553649395] # Start
...
position_open_loop = [-1.53264028230776, -1.3839578938535233, 2.3294294516192835, 3.7716218668171386, -1.5658963362323206, 1.4397766590118408]
position_open_loop2 = [-1.7114089171039026, -1.3297956746867676, 2.2544363180743616, 3.7926174837299804, -1.5668395201312464, 0.6180973052978516]
...
list_to_setp(setp, position_open_loop, offset=6)
con.send(setp)
...
waypoints2 = [
    position2, # Start
    [-0.08743000115155274, 0.6277974698932994, 0.2021465354122779, 2.915860612443099, -1.154742250961211, 0.0010988485280932878]
]
...
print(f"Sent joint positions: {position}")
list_to_setp(setp, position_open_loop2, offset=6)
con.send(setp)
time.sleep(0.5)  # Allow time for movement
